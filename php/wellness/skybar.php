...
<div class="indexbody">
  ...
  <h1 class="wellness-skybar-welcome">Welcome to Pranam Skybar</h1>
  ...
  <div class="wellness-skybar-blog-container">
    ...
    <h2 class="wellness-skybar-h2-in-blog">VIP lounge</h2>
    <p class="wellness-skybar-preview-in-blog">Recommended by the Concierge team at Four Seasons Hotel George V, Paris, this rooftop restaurant occupies the top floor of the Jean Nouvel–designed Musée du quai Branly in the 7th district, and is an easy jaunt from the Hotel. Take a tour of the museum’s exhibitions, or skip the culture and proceed directly to the celebrated menu of French classics. A restaurant for travellers and locals alike, Les Ombres boasts unmatched views of the Eiffel Tower from the terrace.</p>
    <p class="wellness-skybar-reservation-in-blog" >RESERVATIONS:</p>
    <p class="wellness-skybar-reservation-p-in-blog">At least, one day before</p>
    <p class="wellness-skybar-reservation-p-in-blog">Tlf: +34 933 014 484</p>
    <p class="wellness-skybar-reservation-p-in-blog">e-mail: hotel@hotelcurious.com</p>
