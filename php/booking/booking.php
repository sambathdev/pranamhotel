...
<div class="indexbody">
  <div class="center margintop50px">
  ...
  <?php } elseif (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $queryinsert = "INSERT INTO booked_room (name, phone_number, comments, room_id, book_date) VALUES('$name', '$pnumber', '$comments', '$roomid', NOW())";
