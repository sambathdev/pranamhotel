...
<div class="indexbody">
  ...
  <div class="otherindex">
    <div class="center">
      ...
      <div class="col2">
        <h1 class="coltitle">The Terrace</h1>
      ...
      <div class="col3">
        ...
        <h1 class="coltitle">Room Feature</h1>
        <p>33sqm/355sqft</p>
        <p>Air Conditioned</p>
        <p>Connecting Rooms are not available</p>
        <p>Windows, soundproof</p>
        <h4 class="coltitle">Accessible Room Features</h4>
